...
```json
{
  ...
  "plugin": [
    "opencode-goal-mode@git+https://github.com/YanzuoLu/opencode-goal-mode.git#v0.1.8"
  ]
}
```
...
Use a specific tag such as `#v0.1.8`, not a floating branch. Restart opencode after changing the plugin list.
